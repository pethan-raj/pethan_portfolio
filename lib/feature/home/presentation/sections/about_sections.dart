  ...
  final items = [
    {
      "title": "Experience",
      "content":
          "Delivered production-ready mobile applications for enterprise clients and startups, developing scalable Flutter solutions that prioritize performance, reliability, and intuitive user experiences.",
    },
    {
      "title": "Core Expertise",
      "content":
          "Experienced in Flutter, Kotlin, Swift, Firebase, REST APIs, Clean Architecture, MVVM, BLoC, Riverpod, GetX, offline-first development, and cross-platform application delivery.",
    },
    {
      "title": "Career Vision",
      "content":
          "My ambition is to become a Mobile Solutions Architect, combining advanced mobile engineering, system design, cloud technologies, and AI to create products that make a meaningful impact.",
    },
  ];
  @override
  Widget build(BuildContext context) {
